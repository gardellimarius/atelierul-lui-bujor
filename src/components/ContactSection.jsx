...
export default function ContactSection() {
  ...
  async function handleSubmit(e) {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setError('Serviciul de email nu este configurat.')
      setSending(false)
      return
    }
    ...
    try {
      await emailjs.send(
        serviceId,
        templateId,
        { from_name: form.name, from_email: form.email, message: form.message, to_email: contactEmail },
        publicKey
      )
      setSent(true)
    } catch {
            ...
            <motion.div variants={fadeUp}>
              <Box>
                {sent ? (
                  ...
                  <Flex ref={formRef} as="form" onSubmit={handleSubmit} direction="column" gap={6}>
